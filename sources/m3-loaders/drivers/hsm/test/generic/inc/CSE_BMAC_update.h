...
*/
/**
 * @file    CSE_BMAC_update.h
 * @brief   Bolero CSE Boot MAC update support module - header.
...
#ifndef _CSE_BMAC_update_H_
#define _CSE_BMAC_update_H_
 ...
 */
extern int Compute_BMAC(uint8_t* start_ad, uint32_t byte_size, uint8_t* key,
                        uint8_t* result_MAC);

#endif /* _CSE_BMAC_update_H_ */
