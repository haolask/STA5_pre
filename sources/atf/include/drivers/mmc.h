...
#define PART_CFG_PART_USER_ACCESS	(U(0) << 0)
#define PART_CFG_PART_BOOT1_ACCESS	(U(1) << 0)
#define PART_CFG_PART_BOOT2_ACCESS	(U(2) << 0)
#define PART_CFG_PART_RPMB_ACCESS	(U(3) << 0)
