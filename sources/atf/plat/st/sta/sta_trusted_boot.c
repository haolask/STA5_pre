...
/* ROTPK locations */
#define STA_ROTPK_REGS_ID		1
#define STA_ROTPK_DEVEL_RSA_ID		2
...
#if !STA_ROTPK_LOCATION_ID
  #error "STA_ROTPK_LOCATION_ID not defined"
#endif
...
#if (STA_ROTPK_LOCATION_ID == STA_ROTPK_DEVEL_RSA_ID)
...
#elif (STA_ROTPK_LOCATION_ID == STA_ROTPK_REGS_ID)
	uint32_t *src, tmp;
