...
static unsigned char scp_file2_fw_hash_buf[HASH_DER_LEN];
...
static auth_param_type_desc_t scp_file2_fw_hash = AUTH_PARAM_TYPE_DESC(
		AUTH_PARAM_HASH, SCP_FILE2_FW_HASH_OID);
...
static const auth_img_desc_t cot_desc[] = {
	...
	[SCP_FW_CONTENT_CERT_ID] = {
		...
		.authenticated_data = {
			...
			[1] = {
				.type_desc = &scp_file2_fw_hash,
				.data = {
					.ptr = (void *)scp_file2_fw_hash_buf,
					.len = (unsigned int)HASH_DER_LEN
				}
			}
		}
