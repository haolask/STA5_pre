 ...
 * @edid_i2c_add:		EDID I2C address
 * @packet_i2c_add:		packet I2C address
 * @cec_i2c_add:		CEC I2C address
 */
struct adv7511_link_config {
	...
	unsigned int edid_i2c_add;
	unsigned int packet_i2c_add;
	unsigned int cec_i2c_add;
};
