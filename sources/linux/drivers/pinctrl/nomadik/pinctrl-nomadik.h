...
#define PINCTRL_NMK_STA1295	3
#define PINCTRL_NMK_STA1385	4
...
static inline void
nmk_pinctrl_sta1295_init(const struct nmk_pinctrl_soc_data **soc)
{
}

#endif

#ifdef CONFIG_PINCTRL_STA1385
...
static inline void
nmk_pinctrl_sta1385_init(const struct nmk_pinctrl_soc_data **soc)
{
}
