...
static void dwmac4_rd_prepare_tx_desc1(struct dma_desc *p, int is_fs, int len1,
				       int len2, bool tx_own,
				       bool ls)
{
	unsigned int tdes3 = p->des3;
...
const struct stmmac_desc_ops dwmac4_desc_ops = {
	...
	.check_rx_timestamp = dwmac4_rx_check_timestamp,
	.get_timestamp = dwmac4_get_timestamp,
	.set_tx_ic = dwmac4_rd_set_tx_ic,
	.prepare_tx_desc = dwmac4_rd_prepare_tx_desc,
	.prepare_tx_desc1 = dwmac4_rd_prepare_tx_desc1,
