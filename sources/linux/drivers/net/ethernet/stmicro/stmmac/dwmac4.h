...
#define MTL_OP_MODE_TXQ_SIZE(x)		((((x) / 256) \
					  << MTL_OP_MODE_TQS_SHIFT) - 1)
#define MTL_OP_MODE_RXQ_SIZE(x)		((((x) / 256) \
					  << MTL_OP_MODE_RQS_SHIFT) - 1)
...
#define GMAC_PHYIF_CTRLSTATUS_LNKMOD_SHIFT	16
