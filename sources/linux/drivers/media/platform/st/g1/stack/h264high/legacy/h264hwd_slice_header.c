...
/* Code */
    ...
    */
    ...
    if(IS_IDR_NAL_UNIT(pNalUnit))
    {
        ...
        if(value > 65535)
        {
            ERROR_PRINT("idr_pic_id : Bad value out of H264 specification");
            /*
             * Initially the stack returned an 'justified' error but
             * some streams include this mistake and are properly read by
             * other player => so we replaced the error by a trace
             */
            /*return (HANTRO_NOK);*/
        }
    }
