...
u32 DecodeVp7FrameHeader( vpBoolCoder_t*bc, vp8Decoder_t* dec )
{
    ...
    dec->qpYAc = vp8hwdReadBits( bc, 7 );
    STREAM_TRACE("qp_y_ac", dec->qpYAc);
    dec->qpYDc  = vp8hwdReadBits( bc, 1 ) ? (i32)vp8hwdReadBits( bc, 7 ) : dec->qpYAc;
    dec->qpY2Dc = vp8hwdReadBits( bc, 1 ) ? (i32)vp8hwdReadBits( bc, 7 ) : dec->qpYAc;
    dec->qpY2Ac = vp8hwdReadBits( bc, 1 ) ? (i32)vp8hwdReadBits( bc, 7 ) : dec->qpYAc;
    dec->qpChDc = vp8hwdReadBits( bc, 1 ) ? (i32)vp8hwdReadBits( bc, 7 ) : dec->qpYAc;
    dec->qpChAc = vp8hwdReadBits( bc, 1 ) ? (i32)vp8hwdReadBits( bc, 7 ) : dec->qpYAc;
