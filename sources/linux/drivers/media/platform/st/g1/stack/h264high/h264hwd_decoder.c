...
/* Variables */
    ...
    picParamSet_t *picParamSet = NULL;
    strmData_t strm;
...
/* Code */
    ...
    if(!picReady)
    {
        ...
        case NAL_PIC_PARAM_SET:
            ...
            picParamSet = DWLmalloc(sizeof(*picParamSet));
            if (picParamSet != NULL) {
              ...
              ERROR_PRINT("PIC_PARAM_SET allocation failed");
              ret = H264BSD_ERROR;
            }
            goto NEXT_NAL;
    ...
    *skippedBytes = 0;
    ...
    while (1)
    {
            ...
            tmp == NAL_CODED_SLICE_EXT)
        {
            ...
            bitPos = strmData.bitPosInWord + frameNumLen - 1 - TMP_BIT;
