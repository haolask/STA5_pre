...
u32 mpeg2StrmDec_NextStartCode(DecContainer * pDecContainer)
{
    ...
    pStrm = pDecContainer->StrmDesc.pStrmCurrPos + 4;
        ...
        if((tmp >> 8) == 0x1)
        {
            ...
            else
            {
                pDecContainer->StrmDesc.strmBuffReadBits =
                    pDecContainer->StrmDesc.strmBuffSize * 8 - bits + 32;
    ...
    pDecContainer->StrmDesc.strmBuffReadBits =
        pDecContainer->StrmDesc.strmBuffSize*8;
...
u32 mpeg2StrmDec_CheckStuffing(DecContainer * pDecContainer)
{
    ...
    u32 length = (8 - pDecContainer->StrmDesc.bitPosInWord) & 0x3;
