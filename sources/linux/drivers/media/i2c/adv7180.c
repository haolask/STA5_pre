...
#define ADV7180_REG_RST_CLAMP	0x009c
#define ADV7180_REG_AGC_ADJ1	0x00b6
#define ADV7180_REG_AGC_ADJ2	0x00c0
...
static int adv7182_init(struct adv7180_state *state)
{
	...
	adv7180_write(state, ADV7180_REG_EXTENDED_OUTPUT_CONTROL, ret);
...
static int adv7182_set_std(struct adv7180_state *state, unsigned int std)
{
	...
	ret = adv7180_read(state, ADV7182_REG_INPUT_VIDSEL);
	if (ret < 0)
		return ret;
	...
	return adv7180_write(state, ADV7182_REG_INPUT_VIDSEL, ret);
}
