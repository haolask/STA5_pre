 ...
 */
extern uint32_t cse_load_ramkey(uint8_t *key_pt);
 ...
 * @note           The function is blocking and waits for operation completion
 */
extern uint32_t cse_export_ramkey(uint8_t *M1, uint8_t *M2, uint8_t *M3,
 ...
 * @note           The function is blocking and waits for operation completion
 */
extern uint32_t cse_load_key(uint8_t *M1, uint8_t *M2, uint8_t *M3,
