 ...
 * and A7 core in HSM side
 */
#define SHE_REGS1_REMOTE_BASE (ehsm_context.CSE_IF)
...
/**
 * @brief   Mailbox 1 enable switch.
 */
#if !defined(SHE_REGS_USE_REGISTERS1) || defined(__DOXYGEN__)
#define SHE_REGS_USE_REGISTERS1              1
#endif
...
#if SHE_REGS_USE_REGISTERS1 || defined(__DOXYGEN__)
 ...
 */
#define she_get_busy(regsp) ((regsp)->SR.B.BSY != 0U)

/**
 * @brief   Sets the value of the SR.BSY flag.
 * @note    This operation is only meaningful on the remote mailbox.
 */
#define she_set_busy(regsp, flag) ((regsp)->SR.B.BSY = (flag))

/**
 * @brief   Sets the value of the BSY flag.
 * @note    This operation is only meaningful on the remote mailbox.
 */
#define she_set_error(regsp, err) ((regsp)->ECR.R = (err))
...
#if SHE_REGS_USE_REGISTERS1
extern struct she_registers_t SHE_REGS1;
#endif
#endif
