...
#define CSE_ECC_ECDH_FIXED_KEY_AGREEMENT	((uint32_t)0x6A)
#define CSE_ECC_ECDH_FIXED_SERVER_KEY_AGREEMENT	((uint32_t)0x6B)
#define CSE_ECC_REGENERATE_AND_LOAD_KEY_PAIR	((uint32_t)0x6C)
#define CSE_ECC_CHANGE_EC_CURVE			((uint32_t)0x6E)
#define CSE_ECC_GET_CURRENT_EC_CURVE		((uint32_t)0x6F)
#define CSE_ECC_ECDSA_DIGEST_SIGN		((uint32_t)0x70)
#define CSE_ECC_ECDSA_DIGEST_VERIFY		((uint32_t)0x71)
#define CSE_ECC_SCALAR_MULT_ADD			((uint32_t)0x72)

#define CSE_CONVERT_M2_SIZE_4_RAM_KEY_EXPORT	((uint32_t)0x73)
