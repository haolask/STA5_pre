...
int otp_get_security_level(enum t_boot_security_level *plevel)
{
	...
	if (hsm_ret == CSE_NO_ERR) {
		*plevel = (t_boot_security_level)(CSE->P2.R);
		ret = OTP_SUCCESS;
	}
 ...
 * @retval	: OTP_SUCCESS
 */
int otp_get_cust_cert_vers(t_uint32  *pver)
{
	uint32_t  hsm_ret = CSE_NO_ERR;
	int       ret = OTP_FAILURE;
 ...
 * @retval	: OTP_SUCCESS
 */
int otp_get_cust_certif_hash_info(uint32_t *proot_hash_info)
{
	uint32_t  hsm_ret = CSE_NO_ERR;
	int       ret = OTP_FAILURE;
 ...
 * @retval	: OTP_SUCCESS
 */
int otp_get_cust_certif_hash(uint8_t *phash)
{
	uint32_t  hsm_ret = CSE_NO_ERR;
	int       ret = OTP_FAILURE;
 ...
 * @retval	: OTP_SUCCESS
 */
int otp_incr_cust_certif_vers(void)
{
	uint32_t  hsm_ret = CSE_NO_ERR;
	int       ret = OTP_FAILURE;
 ...
 * @retval	: OTP_SUCCESS
 */
int otp_incr_security_vers(void)
{
	uint32_t  hsm_ret = CSE_NO_ERR;
	int       ret = OTP_FAILURE;
 ...
 * @retval	: OTP_SUCCESS
 */
int otp_set_boot_param(struct t_safemem_boot_cfg info)
{
	uint32_t  hsm_ret = CSE_NO_ERR;
	int       ret = OTP_FAILURE;
 ...
 * @retval	: OTP_SUCCESS
 */
int otp_set_cust_certif_hash_info(uint32_t root_hash_info)
{
	uint32_t  hsm_ret = CSE_NO_ERR;
	int       ret = OTP_FAILURE;
 ...
 * @retval	: OTP_SUCCESS
 */
int otp_set_cust_certif_hash(uint8_t *phash)
{
	uint32_t  hsm_ret = CSE_NO_ERR;
	int       ret = OTP_FAILURE;
 ...
 * @retval	: OTP_SUCCESS
 */
int otp_write_enc_boot_key(uint32_t bitSize, uint8_t *pSecBootKey)
{
	uint32_t  hsm_ret = CSE_NO_ERR;
	int       ret = OTP_FAILURE;
 ...
 * @retval	: OTP_SUCCESS
 */
int otp_set_ecc_public_word(uint32_t word_addr)
{
	uint32_t  hsm_ret = CSE_NO_ERR;
	int       ret = OTP_FAILURE;
 ...
 * @retval	: OTP_SUCCESS
 */
int otp_get_ecc_public_word(uint32_t word_addr, uint32_t *p_ecc_set)
{
	uint32_t  hsm_ret = CSE_NO_ERR;
	int       ret = OTP_FAILURE;
 ...
 * @retval	: OTP_SUCCESS
 */
int  otp_set_monotonic_counter_type(t_uint32 type)
{
	uint32_t  hsm_ret = CSE_NO_ERR;
	int       ret = OTP_FAILURE;
 ...
 * @retval	: OTP_SUCCESS
 */
int otp_get_monotonic_counter_type(t_uint32 *ptype)
{
	uint32_t  hsm_ret = CSE_NO_ERR;
	int       ret = OTP_FAILURE;
