 ...
 * @note           -
 */
uint32_t cse_read_fw_version(uint32_t *fw_version)
{
	/*
 ...
 */
uint32_t cse_get_fw_id(uint32_t *fw_id)
{
 ...
 * @note           The function is blocking and waits for operation completion
 */
uint32_t cse_get_id(uint32_t *challenge, uint32_t *UID, uint32_t *status,
		    uint32_t *MAC)
{
	uint32_t ret = CSE_NO_ERR;

	ret = cse_hal_send_cmd4p(CSE_GET_ID, (uint32_t)challenge, (uint32_t)UID,
				 0, (uint32_t)MAC);
 ...
 */
uint32_t cse_init_cse(uint32_t *fw_version)
{
	uint32_t ret = CSE_NO_ERR;
 ...
 * @note           The function is blocking and waits for operation completion
 */
uint32_t cse_secure_boot(uint32_t size, uint32_t *start, uint32_t *fw_version)
{
	uint32_t ret = CSE_NO_ERR;
 ...
 * @note           The function is blocking and waits for operation completion
 */
uint32_t cse_boot_failure(void)
{
	uint32_t ret = CSE_NO_ERR;
 ...
 * @note           The function is blocking and waits for operation completion
 */
uint32_t cse_debug_challenge(uint32_t *challenge)
{
	uint32_t ret = CSE_NO_ERR;
 ...
 *		   from the challenge provided by cse_debug_challenge command
 *
 * @return         Error code
 * @retval 0	   When command is successful
 * @retval 1..21   In case of error - the error code values are the CSE returned
 ...
 * @note           The function is blocking and waits for operation completion
 */
uint32_t cse_debug_auth(uint32_t *authorization)
{
	uint32_t ret = CSE_NO_ERR;
