...
CFG_CRYPTO_SHA384 ?= y
CFG_CRYPTO_SHA512 ?= y
# Default uses the OP-TEE internal Hash implementation
...
CFG_CRYPTO_DH ?= y
CFG_CRYPTO_ECC ?= y
# Default uses the OP-TEE internal ECC implementation
...
# Default uses the OP-TEE internal RNG implementation
