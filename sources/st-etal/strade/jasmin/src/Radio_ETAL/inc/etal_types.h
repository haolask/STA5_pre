...
*/
#define ETAL_TUNESTATUS_SYNCMASK_DABSYNC		ETAL_TUNESTATUS_SYNCMASK_SYNC_ACQUIRED
...
*/
#define ETAL_TUNESTATUS_SYNCMASK_DABMCI  		ETAL_TUNESTATUS_SYNCMASK_COMPLETE
/*!
* 			The ETAL_TUNESTATUS_SYNCMASK_ may be used to access the
* 			m_sync field of the #EtalTuneStatus structure.
