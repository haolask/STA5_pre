...
#ifndef STA710_CUST_SETTINGS_H
#define STA710_CUST_SETTINGS_H
...
{
	/* Look at STA710_OM_CUT_xx.h to find parameters with corresponding addresses */
    _COEFF( iCMT_agcX_ch0_gainDelay__0__           , 0x000000 ),
};

#else /* not defined CMT_DEVICE_INDEPENDENT */

const tCoeffInit coeffInit_STA710[]=
{
	/* Look at STA710_OM_CUT_xx.h to find parameters with corresponding addresses */
    _COEFF( STA710_agcX_ch0_gainDelay__0__         , 0x000000 ),
};

#endif /* CMT_DEVICE_INDEPENDENT */ 

#endif /* STA710_CUST_SETTINGS_H */
