...
#define	COMMON_tracePrintBufUser2(lclass, buffer, len, opt_string)	(COMMON_tracePrintBuf(TR_LEVEL_USER_2, (lclass),(buffer), (len), (opt_string)))
#define	COMMON_tracePrintBufUser1(lclass, buffer, len, opt_string)	(COMMON_tracePrintBuf(TR_LEVEL_USER_1, (lclass),(buffer), (len), (opt_string)))
