...
#define ETALDEMO_ASCTY_DAB_PLUS          0x3F    /* ETSI TS 102 563 V1.1.1 (2007-02), 7.1: ASCTY_DAB_PLUS =111111*/
#define ETALDEMO_DSCTY_MPEG2TS           0x18    /* DMB: data channel with DSCTY = MPEG2-TS */
...
typedef enum
{
    ETALDEMO_COMPONENTTYPE_IS_NO_TYPE              = 0,
    ETALDEMO_COMPONENTTYPE_IS_MSC_STREAM_AUDIO     = 1,
    ETALDEMO_COMPONENTTYPE_IS_MSC_STREAM_DATA      = 2,
    ETALDEMO_COMPONENTTYPE_IS_FIDC                 = 3,
    ETALDEMO_COMPONENTTYPE_IS_MSC_PACKET_DATA      = 4
} ETALDemo_componentTypeTy;
...
static tChar *ETALDcop_dcopLoading_filename[1]={ETAL_DCOP_LOADER_BOOTSTRAP_FILENAME};
#else
