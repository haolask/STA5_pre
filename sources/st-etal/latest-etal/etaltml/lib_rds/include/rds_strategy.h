...
#define ETALTML_RDS_STRATEGY_AFCHECK_DISABLE1STIMERINIT_BG 				(90 - 15)
#define ETALTML_RDS_STRATEGY_AFCHECK_BETWEENLIST1STIMERINIT_BG			2
#define ETALTML_RDS_STRATEGY_AFCHECK_BETWEENFREQ10MSTIMERINIT_BG		1
#define ETALTML_RDS_STRATEGY_AFFASTCHECK_BETWEENLIST1STIMERINIT_BG		1
#define ETALTML_RDS_STRATEGY_AFFASTCHECK_BETWEENFREQ10MSTIMERINIT_BG	1
#define ETALTML_RDS_STRATEGY_AFDISABLE100MSTIMER_BG						50
#define ETALTML_RDS_STRATEGY_PISEEK100MSTIMERINIT_BG					300
#define ETALTML_RDS_STRATEGY_TASEEK100MSTIMERINIT_BG					600
#define ETALTML_RDS_STRATEGY_AFSTART_WAITTIME_BG							18	/*18 ms*/
#endif
...
// change from 0x15 to 0x1B
#define ETALTML_RDS_STRATEGY_THRESHOLD_DETUNING							0x1B	/*depend on the measurement time of rds detector*/	
// change from 0x40 to 0x60
#define ETALTML_RDS_STRATEGY_THRESHOLD_MP								0x60
//change from 0xA0 to 0x64
#define ETALTML_RDS_STRATEGY_THRESHOLD_ADJ								0x64

#define ETALTML_RDS_STRATEGY_THRESHOLD_MPX								0xC0
#define ETALTML_RDS_STRATEGY_THRESHOLD_SNR								0x40
...
#ifdef TUNER_APP_BACKGROUND
	AFCHECK_MODE_BG_REQ,
	AFCHECK_MODE_BG_CHECK,
	AFCHECK_MODE_BG_CHECKEND,
	AFCHECK_MODE_BG_CHECKWAIT
#endif
}RDS_AFModeInfoTy;
...
typedef enum
{
	...
	RDS_FUNC_PISeek,
	RDS_FUNC_TASeek,
	RDS_FUNC_RDS_ENABLED,
	RDS_FUNC_BG_PROC_ACTIVE
}RDS_FuncType;
