...
#define ETAL_VERSION_NAME_MAX   200
...
/*!
 * \def		ETAL_VERSION_DCOP_BOARD_TYPE
 * 			Value of the DCOP Board Type
 */
#define ETAL_VERSION_DCOP_BOARD_TYPE  		 	0x07


/*!
 * \def		ETAL_VERSION_DCOP_NVMLESS_FLAG
 * 			Flag of the DCOP Board Type NVMLESS indication
 */
#define ETAL_VERSION_DCOP_NVMLESS_FLAG  		 	0x40


/*!
 * \def		ETAL_VERSION_DCOP_RAMLESS_FLAG
 * 			Flag of the DCOP Board Type NVMLESS indication
 */
#define ETAL_VERSION_DCOP_RAMLESS_FLAG  		 	0x80
...
#define ETAL_DEF_MAX_ANNOUNCEMENT_SWITCHING_RAW_ITEM              16
...
typedef enum
{
	...
	/*! DAB Audio Bit Error Rate Level */
	EtalQualityIndicator_DabAudioBerLevel,
...
typedef struct
{
    ...
    tU16 announcementType;
    tU8 regionId;
} etalDABAnnouncementRawAutonotifItemTy;

typedef struct
{
    tU8 m_nbOfItems;
    etalDABAnnouncementRawAutonotifItemTy m_item[ETAL_DEF_MAX_ANNOUNCEMENT_SWITCHING_RAW_ITEM];
