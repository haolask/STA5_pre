...
typedef struct
{
	...
	tU32		m_storedInfoBitmap;   /* enum EtalEnumDecodedRDSBitmap can be used to check this parameter */
...
typedef struct
{
	...
	tU32   	m_AFSwitchedFreq;		/*Used for the frequency display during AF switch, AF search*/	
} EtalRDSStrategyStatus;
...
typedef enum
{
	...
	ETAL_PATH_NAME_AM 	    = 5,
	ETAL_PATH_NAME_AM_BG    = 6,
	ETAL_PATH_NAME_FM_HD_FG	= 7,
	ETAL_PATH_NAME_FM_HD_BG = 8,
	ETAL_PATH_NAME_AM_HD    = 9,
	ETAL_PATH_NAME_DRM_1	= 10,
	ETAL_PATH_NAME_DRM_2	= 11
} EtalPathName;
