...
/******************************************************************
 * Do not use this frequency, they are used in DTA
 * It could make a conflict during test execution
 * DAB3: 1473504 174928 176640 180064 199360 209936 239200 225648
 * DABL: 1471792
 * FM  : 107700 101100
******************************************************************/

#define ETAL_VALID_DAB_FREQ    		225648	/* freq used for DE-Augsburg-20090713          */
#define ETAL_VALID_DAB_OTHER_FREQ	229072	/* freq used for DE-Bayern-20090730 and others */
#define ETAL_VALID_DAB_FREQ1_5 		ETAL_VALID_DAB_OTHER_FREQ
...
#define ETAL_EMPTY_DRM_FREQ        	   144
    ...
    #define ETAL_EMPTY_DAB_FREQ    195936 // Seek test assume this is smaller than ETAL_VALID_DAB_FREQ
...
#else
    #define ETAL_EMPTY_DAB_FREQ    174928 // Seek test assume this is smaller than ETAL_VALID_DAB_FREQ
...
/*
 * Values for NRK Alarm Announcement_eti_ni_file.dab
 * ETI file for ANNOUNCEMENT SWITCHING
 */
#define ETAL_DAB_ETI7_ECC             0xE2
#define ETAL_DAB_ETI7_EID             0xFDAB
#define ETAL_DAB_ETI7_UEID            ((ETAL_DAB_ETI7_ECC << 16) | ETAL_DAB_ETI7_EID)
#define ETAL_DAB_ETI7_SERV1_SID       0xFF01 // NRK with announcement

/*
 * Values for Mixed Announcement
 * ETI file for ANNOUNCEMENT SWITCHING
 */
#define ETAL_DAB_ETI8_ECC             0xE0
#define ETAL_DAB_ETI8_EID             0xDE34
#define ETAL_DAB_ETI8_UEID            ((ETAL_DAB_ETI8_ECC << 16) | ETAL_DAB_ETI8_EID)
#define ETAL_DAB_ETI8_SERV1_SID       0xD216 // Announcement Alarm
#define ETAL_DAB_ETI8_SERV2_SID       0xD217 // Announcement Traffic
#define ETAL_DAB_ETI8_SERV3_SID       0xD219 // Announcement Warning
#define ETAL_DAB_ETI8_SERV4_SID       0xD220 // Announcement News
#define ETAL_DAB_ETI8_SERV5_SID       0xD221 // Announcement Weather
#define ETAL_DAB_ETI8_SERV6_SID       0xD222 // Announcement Event
#define ETAL_DAB_ETI8_SERV7_SID       0xD223 // Announcement Special
#define ETAL_DAB_ETI8_SERV8_SID       0xD224 // Announcement Radio Info
#define ETAL_DAB_ETI8_SERV9_SID       0xD225 // Announcement Sport
#define ETAL_DAB_ETI8_SERV10_SID      0xD226 // Announcement Financial

/*
 * Values for FraunhoferIIS-ServiceFollowing-2010-02-25.eti
 */
#define ETAL_DAB_ETI9_ECC             0xE0
#define ETAL_DAB_ETI9_EID             0xDADA
#define ETAL_DAB_ETI9_UEID            ((ETAL_DAB_ETI9_ECC << 16) | ETAL_DAB_ETI9_EID)
#define ETAL_DAB_ETI9_SERVD1_SID      0xDAAA
...
#define ETAL_TEST_REPORT0_LEVEL        (TR_LEVEL_USER_4 + 6)
