...
#define ETAL_MDR_GETMONITORINFO_SKIP_COUNT         4
...
tSInt             ETAL_cmdGetSLI_MDR(ETAL_HANDLE hReceiver, etalCmdActionTy cmd);
...
tSInt             ETAL_cmdStartStopMOT_MDR(ETAL_HANDLE hReceiver, etalMOTserviceTy service, etalCmdActionTy action);
...
tU32 ETAL_getGenericPayloadLen_MDR(tU8 *buf);
tU8 *ETAL_getGenericPayload_MDR(tU8 *buf);
