...
static tSInt etalTestVpaAfStartBgRds(tU8 tcn, EtalBcastStandard std, tU8 processing_features, tBool *pass_out)
{
	...
	*/
	...
	if ((ret = etal_start_RDS(*etaltest_handle, FALSE, 0, ETAL_RDS_MODE)) != ETAL_RET_SUCCESS)
	{
		pass1 = FALSE;
	...
	*/
	...
	if ((ret = etal_start_RDS(*etaltest_handle2, FALSE, 0, ETAL_RDS_MODE)) != ETAL_RET_SUCCESS)
	{
		pass1 = FALSE;
