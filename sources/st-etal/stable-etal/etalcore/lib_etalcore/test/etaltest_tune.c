...
tSInt etalTestTuneReceiver(void)
{
	...
	etalTestPrintNormal("Listen to some audio (1sec) and change volume (20)");
	etal_audio_output_scaling(20);
	OSAL_s32ThreadWait(ETAL_TEST_ONE_SECOND);

	etalTestPrintNormal("Listen to some audio (1sec) and change volume (10)");
	etal_audio_output_scaling(10);
	OSAL_s32ThreadWait(ETAL_TEST_ONE_SECOND);
	...
	etalTestPrintNormal("Listen to some audio (5sec) and change volume (10)");
	etal_audio_output_scaling(10);
	OSAL_s32ThreadWait(ETAL_TEST_ONE_SECOND);
