...
create_window1 (void)
{
  ...
  image45 = gtk_image_new_from_stock ("gtk-save", GTK_ICON_SIZE_MENU);
  gtk_widget_show (image45);
  gtk_image_menu_item_set_image (GTK_IMAGE_MENU_ITEM (save1), image45);
  ...
  image46 = gtk_image_new_from_stock ("gtk-save-as", GTK_ICON_SIZE_MENU);
  gtk_widget_show (image46);
  gtk_image_menu_item_set_image (GTK_IMAGE_MENU_ITEM (save_as1), image46);
  ...
  image47 = gtk_image_new_from_stock ("gtk-quit", GTK_ICON_SIZE_MENU);
  gtk_widget_show (image47);
  gtk_image_menu_item_set_image (GTK_IMAGE_MENU_ITEM (quit1), image47);
  ...
  image48 = gtk_image_new_from_stock ("gtk-dialog-question", GTK_ICON_SIZE_MENU);
  gtk_widget_show (image48);
  gtk_image_menu_item_set_image (GTK_IMAGE_MENU_ITEM (introduction1), image48);
  ...
  image49 = gtk_image_new_from_stock ("gtk-properties", GTK_ICON_SIZE_MENU);
  gtk_widget_show (image49);
  gtk_image_menu_item_set_image (GTK_IMAGE_MENU_ITEM (about1), image49);
  ...
  image50 = gtk_image_new_from_stock ("gtk-justify-fill", GTK_ICON_SIZE_MENU);
  gtk_widget_show (image50);
  gtk_image_menu_item_set_image (GTK_IMAGE_MENU_ITEM (license1), image50);
  ...
  gtk_paned_set_position (GTK_PANED (vpaned1), 1);
  ...
  label1 = gtk_label_new (_("Configuration"));
  ...
  gtk_container_add (GTK_CONTAINER (scrolledwindow4), textview_log);

  label2 = gtk_label_new (_("Log"));
  ...
  GLADE_HOOKUP_OBJECT (window1, textview_log, "textview_log");
