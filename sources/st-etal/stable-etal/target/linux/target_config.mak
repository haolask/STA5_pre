...
# CONFIG_COMM_CMOST_CUSTOMER_SETTINGS is not set
# CONFIG_COMM_DCOP_MDR_FIRMWARE_NO_DOWNLOAD is not set
CONFIG_COMM_DCOP_MDR_FIRMWARE_FILE=y

#
# DCOP MDR firmware download additional support
#
# CONFIG_COMM_DCOP_MDR_FIRMWARE_FILE_MODE_FILE is not set
...
# CONFIG_APP_TEST_LANDSCAPE_MANAGEMENT is not set
# CONFIG_APP_TEST_INITIALIZATION_CUSTOMPARAM is not set
...
# CONFIG_APP_TEST_DATASERVICES_PSD is not set
# CONFIG_APP_TEST_DATASERVICES_SLS_XPAD is not set
# CONFIG_APP_TEST_DATASERVICES_EPG is not set
# CONFIG_APP_TEST_DATASERVICES_JOURNALINE is not set
# CONFIG_APP_TEST_DATASERVICES_TPEG is not set
# CONFIG_APP_TEST_DATASERVICES_DLS is not set
# CONFIG_APP_TEST_DATASERVICES_DLPLUS is not set
# CONFIG_APP_TEST_SEAMLESS is not set
# CONFIG_APP_TEST_DABDATA is not set
...
# CONFIG_APP_TEST_XTAL_ALIGNMENT is not set
CONFIG_APP_TEST_GET_VERSION=y
CONFIG_APP_TEST_DCOP=y
# CONFIG_APP_TEST_SERVICE_SELECT_DCOP is not set
# CONFIG_APP_TEST_TUNE_DCOP is not set
CONFIG_APP_TEST_FM_VPA=y

#
# Build the Debug and Evaluation operations test
#
# CONFIG_APP_TEST_DEBUG_DISS_WSP is not set
# CONFIG_APP_TEST_DEBUG_VPA_CONTROL is not set
...
#
CONFIG_TRACE_CLASS_OSALCORE=2
CONFIG_TRACE_CLASS_ETAL=3
CONFIG_TRACE_CLASS_BOOT=2
CONFIG_TRACE_CLASS_CMOST=2
CONFIG_TRACE_CLASS_TUNERDRIVER=2
CONFIG_TRACE_CLASS_HDRADIO=2
CONFIG_TRACE_CLASS_STECI=3
CONFIG_TRACE_CLASS_BSP=2
CONFIG_TRACE_CLASS_IPFORWARD=2
CONFIG_ENABLE_CLASS_APP_DABMW=3
# CONFIG_ENABLE_CLASS_APP_DABMW_SF is not set
CONFIG_TRACE_CLASS_EXTERNAL=2
...
#
CONFIG_DEBUG_ETAL_CHECKS=y
CONFIG_DEBUG_TYPEDEF_CHECK=y
CONFIG_DEBUG_CONFIG_VALIDATE_CHECK=y
