...
{
#if !defined(CONFIG_STA) || !defined(CONFIG_ARMV7_NONSEC)
	/*
...
#else
	/* No relocation on STA platforms with CONFIG_ARMV7_NONSEC set */
	gd->start_addr_sp = gd->relocaddr;
	gd->relocaddr = (ulong)&_start;  /* Force no relocation */
#endif
